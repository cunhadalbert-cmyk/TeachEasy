...
REGRA DE COMPOSIÇÃO DOS PERSONAGENS: use somente o personagem ou os personagens oficiais que correspondam diretamente ao conteúdo, à ação e ao contexto descritos no texto da atividade. Não inclua personagens adicionais sem necessidade pedagógica. O cachorro oficial só deve aparecer quando fizer sentido para o texto, a ação ou o cenário. Nunca invente, substitua ou misture personagens fora do elenco oficial. O menino moreno SEMPRE usa óculos. O menino de verde NUNCA usa óculos. A menina menor SEMPRE usa óculos. A menina maior NUNCA usa óculos. NÃO troque roupas entre personagens e NÃO altere as cores-base das roupas. Sempre que possível, mantenha os personagens oficiais em pé, com enquadramento completo, sem comprometer a fidelidade visual, a compreensão da cena nem a clareza pedagógica da ilustração.`;
...
Adapte somente o necessário ao conteúdo escolar. Não inclua textos, letras, números escritos, respostas, logotipos ou marcas d'água. Use composição HORIZONTAL, com somente os personagens selecionados pelo contexto totalmente visíveis e sem cortes, adequada para ocupar aproximadamente metade de uma folha A4 ao lado do texto.`;
  ...
  return `${style}${geography}${math} Disciplina: ${subject}. Tema: ${topic}. Contexto pedagógico: ${context || topic}. ORDEM DE PRIORIDADE: 1) preservar visualmente os personagens selecionados da imagem de entrada sem redesenhá-los; 2) selecionar somente os personagens oficiais que correspondam ao texto, à ação e ao contexto pedagógico; 3) manter rosto, cabelo, óculos, roupas-base, proporções, contornos e cores principais idênticos à referência; 4) sempre que possível manter os personagens em pé e com enquadramento completo; 5) ação pedagógica; 6) cenário. Se houver conflito, preserve sempre os itens 1, 2 e 3, mesmo que a ação precise ficar mais simples.`;
}
