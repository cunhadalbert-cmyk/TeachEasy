...
Mantenha o mesmo acabamento visual da referência: renderização digital 3D infantil de alta qualidade, com volume e profundidade reais — pele com leve brilho e sombreamento volumétrico, cabelo com fios individuais visíveis e reflexos de luz, olhos grandes e brilhantes com reflexo de luz (catchlight), roupas e calçados com textura e material visíveis, iluminação com contraste real de luz e sombra. NÃO é uma ilustração plana/vetorial de contornos simples e cores chapadas: é um render com brilho, volume e detalhe, no mesmo padrão de acabamento 3D da referência. Os personagens NÃO podem ganhar um novo estilo de desenho nem perder o acabamento 3D com brilho e volume. NÃO crie cenário de fundo. A composição deve usar somente os personagens oficiais escolhidos e poucos objetos pedagógicos diretamente necessários para representar o tema.
...
ENQUADRAMENTO OBRIGATÓRIO: use composição HORIZONTAL e mantenha TODOS os personagens escolhidos totalmente dentro da imagem, com margem de segurança em todos os lados, especialmente na parte SUPERIOR. NÃO corte cabeça, cabelo, braços, mãos, pernas, pés, cachorro ou objetos pedagógicos importantes. Deixe espaço livre acima dos personagens e não encoste nenhum elemento importante nas bordas. Reduza o tamanho dos personagens se necessário para que caibam completamente na área útil.

FUNDO OBRIGATÓRIO: use fundo totalmente BRANCO ou neutro muito claro, uniforme e vazio. NÃO desenhe paisagem, céu, campo, montanhas, casas ao fundo, ambiente interno, paredes, janelas, vegetação decorativa ou qualquer cenário preenchendo a imagem. Não existe exceção para essa regra. Use somente os personagens oficiais escolhidos e, quando necessário, poucos objetos pedagógicos isolados próximos a eles. Esses objetos devem flutuar visualmente sobre o fundo branco, sem formar um cenário completo.`;
  ...
  const geography = /geograf|migra|famílias migrantes|campo|cidade|paisagem|território|mapa|trajeto/i.test(`${subject} ${topic} ${context}`)
    ? ' Para Geografia, represente o tema somente com os personagens oficiais escolhidos e no máximo poucos objetos isolados, como mapa, mala, caixa, placa, globo, alimento ou outro recurso pedagógico simples. NÃO represente campo, cidade, casa, estrada, paisagem ou ambiente completo ao fundo. NÃO crie agricultores, professores, familiares, trabalhadores ou qualquer outra pessoa que não pertença ao elenco oficial.'
    : '';
