...
FUNDO: prefira fundo BRANCO, cinza muito claro ou neutro, limpo e sem cenário colorido. Não use paisagem ampla, céu colorido, ambiente interno detalhado ou fundo ilustrado grande, a menos que seja indispensável para entender a atividade. Se precisar contextualizar, use apenas poucos objetos pedagógicos isolados, sem preencher o fundo inteiro. O foco principal deve ser os personagens e a ação relacionada ao texto. A ilustração deve ficar visualmente parecida com um quadro limpo de material pedagógico, funcionando bem em aproximadamente metade de uma folha A4 ao lado do texto.`;
