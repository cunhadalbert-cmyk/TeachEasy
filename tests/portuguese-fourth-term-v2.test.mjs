...
test('Português do 4º bimestre possui 50 atividades V2 do 1º ao 9º ano', () => {
  ...
  for (let year = 1; year <= 9; year += 1) {
    ...
    const file = new URL(`../data/atividades/${segment}/${year}-ano/4-bimestre/lingua-portuguesa.json`, import.meta.url);
