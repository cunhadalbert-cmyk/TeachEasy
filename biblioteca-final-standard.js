(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .te-final-text h3{color:#2e7d32;font-size:11pt;margin:0 0 1.5mm}.te-final-visual{border-left:1px solid #5f6b73;display:flex;align-items:center;justify-content:center;overflow:hidden;background:#f8fbfd}.te-final-visual img{width:100%;height:100%;object-fit:contain;display:block}
